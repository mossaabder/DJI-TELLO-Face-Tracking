...
# cap = cv2.VideoCapture(0)
# url = "http://10.46.16.169:8080/video"       #comment for the static test
# cap = cv2.VideoCapture(url)                  #comment for the static test
while True:

    # _, img = cap.read()                      #comment for the static test
    #### Testing on a static image
    img = cv2.imread("Test_line_follower/Photo_orange.JPG")
    ####
